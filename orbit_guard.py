...
SCRIPTABLE_STATE   = SCRIPTABLE_DIR / "focusguard_state.json"    # iOS widget 读
SCRIPTABLE_TIMELINE= SCRIPTABLE_DIR / "focusguard_timeline.json" # iOS 时间块查看
COMMAND_FILE       = APP_SUPPORT / "command.json"                # 桌面 widget 写命令
SCRIPTABLE_COMMAND = SCRIPTABLE_DIR / "focusguard_command.json"  # iOS Scriptable 写命令
